...
import BgVideo from "../../assets/video.mp4"; // Background video
import "./Home.css";
        ...
        <div className="background-video">
          ...
          <div className="content">
            <div className="menu_content">
              ...
              <p>
                With Bobosoho Shop, pay a yearly subscription of only 19.50 € per year
                for up to 15 users and select one of each of the following software.
              </p>
